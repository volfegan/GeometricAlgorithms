...
The implementation here is a better version than the CodingTrain QuadTree. I used binary tree for the internal search (TreeSet) so we get log(n) speed on get, add, remove processes.
